!function() {
    ...
    108: function(e, t, a) {
        ...
        var i, r, n, d = Math.pow, o = Math.abs, c = s(a(109)), u = s(a(5)), l = a(14), h = getApp(), f = a(1).default, p = a(0), C = "page/bus/webapp/booking/booking", y = {
            prevPriceItem: {},
            topspeed: null,
            oneYuan: null,
            refund: null
        ...
        Page((r = {
            ...
            onLoad: function() {
                var e, t, a, s = this, i = this, r = wx.getStorageSync("bus_TicketInfo");
                ...
                i.setData({
                    ...
                    try {
                        ...
                        var t, a = p.format1(new Date(e.dptDateTime), "yyyy/MM/dd") == p.format1(new Date(e.currDateTime.replace(/-/g, "/")), "yyyy/MM/dd"), s = "";
                    ...
                    (t.serviceResponse || []).forEach(function(t) {
                        switch (i.data.sortList[t.code] = {
                          ...
                          case "function":
                            var a = (t.value || []).length, r = a ? t.value[a - 1] : {};
                    ...
                    b = e.inteligentRevenueDetail && e.inteligentRevenueDetail.revenueRecommendCode || "", 
                    -1 == S.indexOf(0) && e.hotelVoucher && !p.isEmpty(e.hotelVoucher) && (0 <= (I = e.hotelVoucher[0].vouInstruction).indexOf("<br>") && (e.hotelVoucher[0].vouInstruction = I.split("<br>")), 
                    ...
                    if (e.simpleTypeList && e.simpleTypeList.length) {
                        ...
                        for (var m = g, P = Array.isArray(m), w = 0, m = P ? m : m[Symbol.iterator](); ;) {
                            ...
                            y.topspeed = x, i.setData({
                                ...
                                var k = i.data.stList, A = k.findIndex(function(e) {
                        ...
                        if (a = !0, 3 == i.data.localInfo.revenueType) {
                            for (var N = i.data.localInfo.superValue.insCodeList, E = Array.isArray(N), M = 0, N = E ? N : N[Symbol.iterator](); ;) {
                                ...
                                if ("break" === function() {
                                    ...
                                    var t = O, a = e.insurances.findIndex(function(e) {
                                        return t == e.code;
                                    });
                    ...
                    if (t.length && (i.setData({
                        ...
                        var r = a, n = !p.isEmpty(r.timeCard);
                        i.setData({
                            isHasRedCardUse: n,
            ...
            onShow: function() {
                ...
                wx.setStorageSync("bus_addressInfo", {}); else {
                    var e = this, t = wx.getStorageSync("bus_newAddPassenger") || "", a = wx.getStorageSync("bus_updatePassenger") || "", s = wx.getStorageSync("bus_addressInfo") || "", i = e.data.passengers.length;
                    ...
                    this.funRedderCards();
                    var r = wx.getStorageSync("refundStatus"), n = this.data.ajaxIsShowSuixin;
            ...
            fnCalculateCount: function() {
                var e = this, t = this.data.plists, a = {
                    adultPriceCount: 0,
                    childPriceCount: 0,
                    fullPriceChild: 0,
                    adultCount: 0,
            ...
            reqGetOrderTotalAmount: function() {
                var e = this, t = this.data, a = t.busInfo, s = this.funComposePriceItem();
                return this.setData({
                    prevPriceItem: s
            ...
            funComposePriceItem: function() {
                var e = this.data, t = this.data.busInfo, a = this.fnCalculateCount(), s = a.adultPriceCount, i = a.childPriceCount, r = e.plists.length, n = (y.insItem, 
                {
                ...
                n.destinationInsurancePrice = 0, n.phoneLostInsurancePrice = 0; else {
                ...
                var l = 3 == e.localInfo.revenueType ? e.localInfo.revenuePrice : e.isAdult ? e.defaultOpt.sellPrice * r : e.defaultExt.sellPrice * r, h = p.isEmpty(e.addressInfo) || !e.addressInfo.expressFee || e.homeDelivery.show ? 0 : e.addressInfo.expressFee, f = !p.isEmpty(e.addressInfo) && e.addressInfo.agentFee ? e.addressInfo.agentFee * (s + i) : 0;
                return {
            ...
            accAddSub: function(e, t, a) {
                ...
                var l;
                if (a) l = Array.from((e + t).toString()); else {
                    if (e < t) {
                        i = !0;
                        var h = e;
                        e = t, t = h;
                ...
                if (l.length < u) for (var f = 0; f < u - l.length; f++) l.unshift("0");
                l.splice(-1 * u, 0, ".");
            ...
            composeAlterData: function() {
                var e, t, a = this, s = a.data.busInfo.dptDate, i = a.data.busInfo.dptDateTime, r = new Date(i), n = new Date(), d = p.format1(n, "yyyy-MM-dd");
            ...
            btnChoseSpan: function(e) {
                var t = e.currentTarget.dataset.idx, a = this.data.alterHour;
            ...
            btnNotChoseAlter: function(e) {
                var t = this.data.alterDay, a = this.data.alterHour;
            ...
            btnChoseAlter: function() {
                var e, t = this, a = this.data.alterDay, s = this.data.alterHour, i = !1, r = !1;
                ...
                void t.judgeWechatCardIsCanUse(t.data.cardMsg)) : (p.alert("请选择备选时段"), u.default.setEvent(C, "DLDD18", "^名称:[请选择备选时段]^"), 
                !1) : (p.alert("请选择备选日期"), u.default.setEvent(C, "DLDD18", "^名称:[请选择备选日期]^"), !1);
            },
            ...
            updateAlterTxt: function(e) {
                ...
                var t, a = this.data.alterDay, s = this.data.alterHour, i = 0, r = !1, n = [];
                a.forEach(function(e) {
            ...
            btnCarCount: function(e) {
                ...
                if (e && (9 == t || 9 < t)) return p.alert("对不起，最高限制购买9份！"), u.default.setEvent(C, "DLDD18", "^名称:[购买汽车票券]^"), 
                !1;
                if (e) t++; else {
                    if (!(0 < t)) return;
                    t--;
            ...
            reqGetLastPassengers: function() {
                var e = this, t = wx.getStorageSync("bus_lastPassengers") || [];
                    ...
                    wx.request({
                        ...
                        success: function(s) {
                            if (wx.hideToast(), (s = s.data).header.isSuccess) {
                                var i = e.funFilterIDcards(s.body), r = e.funSetSelected(i);
                                if (e.data.plists.length) for (var n = e.data.plists, d = Array.isArray(n), o = 0, n = d ? n : n[Symbol.iterator](); ;) {
                                    var c;
                                    if (d) {
                                        if (o >= n.length) break;
                                        c = n[o++];
            ...
            funSetSelected: function(e) {
                ...
                return t = function(e) {
                    var t, s = !1;
                    for (t = 0; t < a.length; t++) if (a[t].linkerName == e.linkerName && a[t].IDCard == e.IDCard) {
                        s = !0;
                        break;
                    }
                    return s;
            ...
            funIsHasAdult: function() {
                var e = this, t = !1, a = this.data.plists;
                this.data.isSupportChild;
                if (a.length) for (var s = a, i = Array.isArray(s), r = 0, s = i ? s : s[Symbol.iterator](); ;) {
                    var n;
                    if (i) {
                        if (r >= s.length) break;
                        n = s[r++];
                ...
                if (this.setData({
                    ...
                    var o = wx.getStorageSync("bus_optimizationLists"), c = wx.getStorageSync("bus_offLine_youxuan");
                    if (e.setData({
                        slectedVAList: o,
                    ...
                    var l = wx.getStorageSync("bus_extremeLists"), h = wx.getStorageSync("bus_offLine_zhizun");
                    if (e.setData({
                        slectedVAList: l,
            ...
            eighteenYears: function(e) {
                var t = this.data.busInfo.currDateTime || p.format(new Date()), a = parseInt(t.substr(0, 4)) - e.substr(6, 4), s = parseInt(t.substr(5, 2) + t.substr(8, 2)), i = parseInt(e.substr(10, 2) + e.substr(12, 2));
                return !(18 > a || 18 == a && !(i <= s));
            },
            funIsHasService: function() {
                var e = this, t = this.data.busInfo, a = t.ticketPrice, s = function() {
                    var t = 0;
            ...
            funCountPrice: function(e) {
                var t = this, a = t.fnCalculateCount(), s = a.adultPriceCount, i = a.childPriceCount, r = this.data.isAdult ? this.data.defaultOpt : this.data.defaultExt, n = 3 == this.data.localInfo.revenueType, d = function() {
                    var e = 0;
                ...
                var l = p.isEmpty(this.data.addressInfo) || !this.data.addressInfo.expressFee || this.data.homeDelivery.show ? 0 : this.data.addressInfo.expressFee, h = !p.isEmpty(this.data.addressInfo) && this.data.addressInfo.agentFee ? 1e3 * this.data.addressInfo.agentFee * (s + i) / 1e3 : 0, f = (1e3 * (p.isEmpty(this.data.carCoupon) || 0 == this.data.carCouNum ? 0 : this.data.carCoupon.vouSellPrice * this.data.carCouNum) + 1e3 * (p.isEmpty(this.data.hotelCoupon) || 0 == this.data.hotelCouNum ? 0 : this.data.hotelCoupon.vouSellPrice * this.data.hotelCouNum) + u + (1e3 * (this.data.isPeaceTravel && this.data.defIns.insCusPayTc && this.data.isAdult && this.data.defInsDb ? this.data.defIns.insCusPayTc : 0) + 1e3 * (!this.data.isPeaceTravel && d && this.data.isAdult ? d : 0) + 1e3 * (this.data.isHasService ? this.data.busInfo.serviceChargePrice : 0) + 1e3 * (n && this.data.localInfo.revenuePrice ? this.data.localInfo.revenuePrice : 0) + 1e3 * (!n && this.data.isPeaceTravel && this.data.isAdult && !this.data.defInsDb && !p.isEmpty(r) && r.sellPrice ? r.sellPrice : 0) + 1e3 * (n || !this.data.isPeaceTravel || this.data.isAdult || p.isEmpty(r) || !r.sellPrice ? 0 : r.sellPrice) + 1e3 * (n || this.data.isPeaceTravel || p.isEmpty(r) || !r.sellPrice ? 0 : r.sellPrice) + 1e3 * (this.data.YyStatus ? this.data.YyData.price : 0) + 1e3 * (this.data.IssueStatus ? this.data.speedPrice : 0) + 1e3 * (this.data.refundStatus ? y.refund.price : 0) + 1e3 * (4 == this.data.localInfo.revenueType && this.data.localInfo.revenuePrice ? this.data.localInfo.revenuePrice : 0) + 1e3 * (this.data.subscribeInfoObj.isSubscribe && !this.data.ASisExceedLimit && this.data.vipSubscribe ? this.data.vipSubscribePrice : 0) + 1e3 * (0 == this.data.adjustPrice ? 0 : this.data.adjustPrice)) * (s + i) - 1e3 * (this.data.selectedPrefer && !p.isEmpty(this.data.preferInfo) ? this.data.preferInfo.preferentialType : 0) * (this.data.preferInfo.preferentialDimension ? s + i : 1) - (p.isEmpty(this.data.selectCode) || 0 == s + i ? 0 : 1e3 * this.data.selectCode.showPrice) + 1e3 * (this.data.busVoucherIsSel && !p.isEmpty(this.data.busVoucher) && this.data.busVoucher.vouSellPrice ? this.data.busVoucher.vouSellPrice : 0) + 1e3 * (this.data.isHasRedCardBuy && this.data.isSelectedRedCard ? this.data.reduceCard_buy.sellPrice : 0) + 1e3 * (this.data.homeDeliveryStatus ? (1e3 * l + 1e3 * h) / 1e3 : 0)) / 1e3;
                ...
                var C = 0, g = p.isEmpty(this.data.selectCode) || 0 == s + i ? 0 : this.data.selectCode.showPrice, v = this.data.isSelectedRedCard ? this.data.isHasRedCardUse ? this.data.reduceCard_use.discountMoney : this.data.reduceCard_buy.discountMoney : 0;
                ...
                if (this.setData({
                    ...
                    var D = t.funComposePriceItem(), S = !1;
                    for (var I in D) if ((0, c.default)(D[I]) != (0, c.default)(this.data.prevPriceItem[I]) || D[I] != this.data.prevPriceItem[I]) {
                        S = !0;
                        break;
                    }
                ...
                if (t) {
                    if (this.setData({
                        ...
                        t.forEach(function(t) {
                            0 < t.pubID && (e.data.isAdult && e.data.isHasOptSvc && 0 <= e.data.defaultOpt.insuranceTypeList.indexOf(t.insCode + "") && e.funGetSetOptExtNoBuyItem("bus_optimizationLists"), 
                            !e.data.isAdult && e.data.isHasExtSvc && e.funGetSetOptExtNoBuyItem("bus_extremeLists"));
                        });
                    }
            ...
            funGetSetOptExtNoBuyItem: function(e) {
                var t = this, a = "bus_optimizationLists" == e ? "bus_optimizationDefault" : "bus_extremeDefault", s = "bus_optimizationLists" == e ? "defaultOpt" : "defaultExt";
            ...
            btnEditPass: function(e) {
                for (var t, a, s = e.currentTarget.dataset, i = 1 == s.type ? "editChild" : "editAdult", r = this.data.passengers, n = 0; n < r.length; n++) if (a = r[n], 
            ...
            btnEditChild: function(e) {
                var t = e.currentTarget.dataset, a = t.cname, s = t.cid, i = this.data.fillPassList.find(function(e) {
            ...
            refreshPlists: function(e) {
                ...
                return s > this.data.maxNum ? (p.alert("最多只能添加" + this.data.maxNum + "名乘车人!"), u.default.setEvent(C, "DLDD18", "^名称:[添加乘客超出最大人数]^"), 
                !1) : (a && i > this.data.childMaxNum && (p.alert("最多只能添加" + this.data.childMaxNum + "名儿童!"), 
            ...
            refreshPriceCard: function() {
                var e = {};
                if (this.data.isSupportChild) for (var t = this.data.plists, a = Array.isArray(t), s = 0, t = a ? t : t[Symbol.iterator](); ;) {
                    var i;
                    if (a) {
                        if (s >= t.length) break;
                        i = t[s++];
            ...
            btnSelectPass: function(e) {
                var t = this, a = e.currentTarget.dataset, s = this.data.passengers, i = 0, r = 0;
                if (!parseInt(a.state)) {
            ...
            getItemIndex: function(e, t) {
                for (var a, s = this, i = 13 == (e = e.toString()).length ? "addTime" : "IDCard", r = 13 == e.length ? s.data.fillPassList : s.data.plists, n = 0; n < r.length; n++) if ((a = r[n])[i] == e) return t ? a : n;
            },
            fillName: function(e) {
                var t, a = e.currentTarget.dataset.serial, s = this.data.fillPassList[a], i = e.detail.value;
                this.setData((t = {}, t["fillPassList[" + a + "].linkerName"] = i, t["fillPassList[" + a + "].idFocus"] = !1, 
                t)), this.checkNameId(s);
            },
            fillId: function(e) {
                var t, a, s = e.currentTarget.dataset.serial, i = this.data.fillPassList[s], r = e.detail.value.replace(/\s/g, ""), n = r.length, d = !0, o = e.currentTarget.dataset.pname, c = /^[a-zA-Z\u4e00-\u9fa5]+$/gi;
            ...
            fillIdBlur: function(e) {
                var t, a = e.currentTarget.dataset.serial, s = (this.data.fillPassList[a], e.detail.value.replace(/\s/g, ""));
            ...
            checkNameId: function(e) {
                var t, a = this.data.plists, s = this.data.fillPassList, i = /^[a-zA-Z\u4e00-\u9fa5]{2,}$/, r = !0;
                (function() {
                    for (var s, i = 0; i < a.length; i++) if ((s = a[i]).addTime && s.addTime == e.addTime) {
                        r = !1, t = i;
                        break;
                    }
            ...
            inputPhoneNum: function(e) {
                var t, a = e.detail.value.replace(/\s/gi, ""), s = a.length;
            ...
            btnDeletePass: function(e) {
                var t = e.currentTarget.dataset.serial, a = [];
                ...
                0); d < r.length; d++) if (r[d].linkerName == i && r[d].IDCard == s) {
                ...
                for (d = 0; d < n.length; d++) if (n[d].linkerName == i && n[d].IDCard == s) {
                    n[d].selected = !1;
                    break;
                }
                this.setData({
            ...
            fnShowFCDeleteBtn: function(e) {
                var t = e.currentTarget.dataset.idx, a = this.data.passengers.length ? this.fnFindMapchildParent(e) : this.fnFindMapchildParent(e, this.data.fillPassList);
            ...
            btnDeleteFreeChild: function(e) {
                var t, a = e.currentTarget.dataset.idx, s = this.fnFindMapchildParent(e);
            ...
            btnEditFreeChild: function(e) {
                var t = JSON.parse(JSON.stringify(this.data.plists)), a = e.currentTarget.dataset.idx, s = this.fnFindMapchildParent(e);
            ...
            fnFindMapchildParent: function(e, t) {
                var a, s, i = e.currentTarget.dataset.pid, r = e.currentTarget.dataset.pname;
            ...
            contactPhone: function() {
                var e, t = wx.getStorageSync("bus_newContactPhone") || "", a = t.length;
            ...
            funValidateNameNotice: function(e) {
                var t = e.linkerName, a = e.IDCard, s = /^[a-zA-Z\u4e00-\u9fa5]+$/;
            ...
            btnToPay: function() {
                ...
                var t, a, s, i, r = this, n = this.data.contactPhone, d = [], o = 0, c = r.fnCalculateCount(), l = c.adultCount, D = c.childCount, S = c.adultPriceCount, I = c.childPriceCount, m = "", P = null, w = "", T = r.data.fillPassList, x = !0, k = {};
                if (r.data.isSuggestChoseAlter && 2 == r.data.busInfo.bookingType && !r.data.isCheckAlternate && "A" != r.data.isSimpleBeixuan && 0 == I) return r.setData({
                    ...
                    isShowAlter: !0
                }), this.updateAlterTxt(), this.updateOptionsSchedulesTimes(), this.data.isCanclePay = !1, 
                !1;
                ...
                u.default.setEvent(C, "DLDD18", "^名称:[超值套票需要包含成年人才能购买哦]^"), this.data.isCanclePay = !1, 
                !1;
                ...
                }), u.default.setEvent(C, "DLDD18", "^名称:[请输入正确的手机号码]^"), this.data.isCanclePay = !1, 
                !1;
                ...
                u.default.setEvent(C, "DLDD18", "^名称:[最多只能预订" + r.data.maxNum + "张票!]^"), this.data.isCanclePay = !1, 
                !1;
                ...
                r.setData({
                    ...
                    idType: 1,
                    passengerType: 0
                }, m = r.data.localInfo.exData ? r.data.localInfo.exData : r.data.busInfo.exData1 ? r.data.busInfo.exData1 : "", 
                !p.isEmpty(r.data.preferInfo) && r.data.selectedPrefer && (P = [ {
                ...
                var Y = r.data.busInfo, W = r.data.localInfo, G = r.data;
                (e = {
                ...
                var z = [];
                if (r.data.passengers.length) for (var J = r.data.plists, $ = Array.isArray(J), X = 0, J = $ ? J : J[Symbol.iterator](); ;) {
                    var Z;
                    if ("break" === function() {
                        if ($) {
                        ...
                        var e = Z, t = !!r.data.passengers.find(function(t) {
                ...
                } else for (var K = r.data.plists, Q = Array.isArray(K), ee = 0, K = Q ? K : K[Symbol.iterator](); ;) {
                    var te;
                    if (Q) {
            ...
            WXMobileGatewayRequest: function(e) {
                ...
                var t = this, a = e.body.encryptOrderId, s = e.body.serialId, i = t.data.totalPrice.toString(), r = wx.getSystemInfoSync().model.match("iPhone") ? 2 : 1;
                try {
            ...
            funGetWechatCard: function(e) {
                var t = this, a = t.fnCalculateCount(), s = a.adultPriceCount, i = a.childPriceCount;
                1 == e ? t.setData({
                    isChangeNumber: !0
                }) : t.setData({
                    isChangeNumber: !1
                ...
                wx.request({
                    ...
                    success: function(a) {
                        var s = a.data.body, i = a.data.header;
            ...
            judgeWechatCardIsCanUse: function(e) {
                var t;
                if (!p.isEmpty(e)) {
                    var a = this, s = a.data.isAdult ? a.data.defaultOpt : a.data.defaultExt, i = p.isEmpty(e.canUseList) ? [] : e.canUseList, r = (e.cannotUseList, 
                    0), n = 0, d = !1, o = !1;
                    ...
                    }), a.data.isPeaceTravel ? (a.data.isAdult ? (a.data.defInsDb && a.data.defIns.pubID && (d = !0), 
                    !a.data.defInsDb && !p.isEmpty(s) && s.sellPrice && (o = !0)) : !p.isEmpty(s) && s.sellPrice && (o = !0), 
                    ...
                    t["cardMsg.canUseList"] = i, t.isGetCard = !!(0 < r), t)), r ? function() {
                        var e = wx.getStorageSync("bus_cardCode") || "", t = !1;
                        if (e) {
            ...
            wechatCardIsInclude: function(e, t) {
                if (e && e.length) for (var a, s = 0; s < e.length; s++) if (a = e[s], !p.isEmpty(a) && a.servId == t) return !0;
                return !1;
            },
            ...
            funRedderCards: function() {
                ...
                if (t) {
                    for (var a = 0; a < e.data.cardMsg.canUseList.length; a++) if (e.data.cardMsg.canUseList[a].code == t) {
            ...
            btnSelectContact: function(e) {
                var t, a, s = e.currentTarget.dataset.cid, i = e.currentTarget.dataset.cname, r = this.data.plists;
                for (a = 0; a < r.length; a++) if (r[a].linkerName == i && r[a].IDCard == s) {
                    t = r[a];
                    break;
                }
                this.setData({
            ...
            btnOpenNotice: function(e) {
                var t = p.extend({}, this.data.busInfo), a = this.data, s = e.currentTarget.dataset.type || "qu";
            ...
            busVoucherSel: function() {
                var e = this, t = !e.data.busVoucherIsSel;
                e.setData({
                    busVoucherIsSel: t
                }), e.funCountPrice();
            },
            ...
            selectService: function(e) {
                var t, a = e.currentTarget.dataset.key, s = (e.currentTarget.dataset.rmb, !this.data[a]), i = this.data.isShowSpeed, r = this.data.isShowrefund;
                if ("refundStatus" == a) this.data.refundSuixin ? "随心退" : "退改无忧", this.data.refundSuixin ? "DD056" : "DD018"; else if ("YyStatus" == a) ; else if ("IssueStatus" == a) ; else if ("homeDeliveryStatus" == a) {
                    var i = !1, r = !1;
            ...
            btnSelectService: function(e) {
                var t = parseInt(e.currentTarget.dataset.sid), a = parseInt(e.currentTarget.dataset.index), s = parseInt(e.currentTarget.dataset.price), i = this.data.slectedVAList, r = {}, n = this, d = n.data.defInsMulti;
                n.setData({
                    checkedServiceId: t
                });
            ...
            btnValueaddDetail: function(e) {
                for (var t = this.data.slectedVAList, a = parseInt(e.currentTarget.dataset.pid), s = 0; s < t.length; s++) if (t[s].serviceId == a) {
                    this.setData({
            ...
            p.isEmpty(e.data.svcNotice) ? p.$http(f.getSvcNotice, {
                ...
                if (!p.isEmpty(t) && t.notice) {
                    var a = t.notice, s = (a = a.replace(/<\/span>|<\/p>|(<p|<span) class="[\w-]*">|<p>/gi, "")).split("<br>");
            ...
            var t = e.currentTarget.dataset, a = wx.getStorageSync("bus_insuranceLists");
            if (this.setData({
                selectInsOrVA: "insurance"
                ...
                wx.setStorageSync("bus_insurance_style_2", {
                    code: t.code,
                    index: -1
                }), u.default.setEvent(l.booking, "DLDD10", "^增值服务名称[" + this.data.defInsMulti[t.index].insName + "]^单价[" + this.data.defInsMulti[t.index].insCusPayTc + "]^按钮状态:[" + (0 < this.data.defInsMulti[t.index].insCusPayTc ? "开" : "关") + "]^"), 
                !1;
            }
            wx.setStorageSync("bus_insurance_style_2", {
                code: t.code,
            ...
            var t = e.currentTarget.dataset, a = wx.getStorageSync("bus_insuranceLists")[t.index].value, s = this.data.defInsMulti[t.index];
            ...
            var t, a = parseInt(e.currentTarget.dataset.pid), s = this.data.slectedVAList, i = !1;
            this.setData({
                selectInsOrVA: "valueadd"
            }), i = this.data.isAdult ? !(this.data.defaultOpt.serviceId != a) : !(this.data.defaultExt.serviceId != a);
            for (var r = 0; r < s.length; r++) if (i && 0 == s[r].sellPrice) t = s[r]; else if (!i && s[r].serviceId == a) {
                t = s[r];
                break;
            }
            ...
            var t = this, a = e.currentTarget.dataset.type, s = this.data.serviceMsg, i = "";
            ...
            var t = e.currentTarget.dataset, a = this;
            ...
            var e = this, t = this.data.busInfo;
            ...
            var t = e.currentTarget.dataset, a = null, s = [], i = [];
            ...
            var e = this.data, t = this, a = e.busInfo;
